...
echo -en 'backend default { .host = "www.vclfiddle.net"; .port = "80"; }' >$TEST_DIR/default.vcl

echo $TEST_DIR
/opt/vclfiddle/run-varnish-container varnish3 $TEST_DIR
...
echo -en "GET / HTTP/1.1\r\nHost: www.vclfiddle.net\r\n\r\n" >$TEST_DIR/request_0
echo -en 'backend default { .host = "www.vclfiddle.net"; .port = "80"; } sub vcl_recv { set beresp.http.Foo = "bar"; }' >$TEST_DIR/default.vcl
